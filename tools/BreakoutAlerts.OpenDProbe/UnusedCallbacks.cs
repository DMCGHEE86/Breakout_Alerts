...
/// <summary>
/// Empty implementations of the <see cref="FTSPI_Qot"/> members this probe does not use.
/// </summary>
/// <remarks>
/// <b>Generated, not hand-written.</b> FTSPI_Qot is a ~150-member interface with no default
/// implementations, so a class that wants three of its callbacks must still supply the
/// other 147. These were produced by compiling with only the wanted handlers, capturing the
/// compiler's own CS0535 list, and emitting one stub per member - faster than transcribing
/// them and incapable of drifting from the real signatures.
///
/// <para>The handlers this probe actually cares about - snapshot, history and option chain
/// - are in Program.cs. Regenerate this file if futu-api is upgraded and the interface
/// gains members.</para>
/// </remarks>
